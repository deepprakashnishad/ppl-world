...
export class PriceService {
  ...
  bulUpdateInventoryList(inventoryList): Observable<any>{
    return this.http.put<any>(this.priceUrl+"/bulkUpdate", inventoryList)
      .pipe(
        catchError(this.handleError('Bulk update Price', null))
      )
  }
